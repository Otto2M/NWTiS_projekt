...
<head>
<meta charset="UTF-8">
<title>Pogled 5.5.4. - pretraživanje</title>
<style type="text/css">
	body {
...
<body>
	...
	<h4>Pretraživanje udaljenost od/do odabranih aerodroma</h4>
	
	<form method="GET" action="${pageContext.servletContext.contextPath}/mvc/aerodromi/icaoOdDoUdaljenost">
	<div class="labele">

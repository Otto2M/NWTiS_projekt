...
<head>
<meta charset="UTF-8">
<title>Pogled 5.5.5. - pretraživanje</title>
<style type="text/css">
	body {
...
<body>
	...
	<h4>Pretraživanje udaljenost između dva aerodroma</h4>
	
	<form method="GET" action="${pageContext.servletContext.contextPath}/mvc/aerodromi/udaljenostDvaAerodroma">
	<div class="labele">

...
<body>
	...
	<h1>Pregled udaljenosti i aerodroma do polaznog aerodroma unutar države odredišnog aerodroma</h1>
	
	<div class="poveznica">
	  <a href="${pageContext.servletContext.contextPath}" target="_self">Početna stranica</a><br><br>
	  <a href="${pageContext.servletContext.contextPath}/mvc/aerodromi/traziIcaoOdDo" target="_self"">Novi unos</a>
	</div>
	...
	<table>
		...
		<tbody>
			<%
			List<UdaljenostAerodrom> udaljenosti = (List<UdaljenostAerodrom>) request.getAttribute("udaljenost1");

...
<body>
	...
	<h1>Pregled udaljenosti između dva aeorodroma</h1>
	
	<div class="poveznica">
	  <a href="${pageContext.servletContext.contextPath}" target="_self">Početna stranica</a><br><br>
	  <a href="${pageContext.servletContext.contextPath}/mvc/aerodromi/traziUdaljenostDvaAerodroma" target="_self"">Novi unos</a>
	</div>
	
	<%
	String icaoOd = (String) request.getAttribute("icaoOd");
	String icaoDo = (String) request.getAttribute("icaoDo");
	Double udaljenost = (Double) request.getAttribute("udaljenostBroj");
	%>
	<br>

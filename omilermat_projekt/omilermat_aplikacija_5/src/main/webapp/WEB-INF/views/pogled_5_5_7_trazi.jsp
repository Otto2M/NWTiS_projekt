...
<head>
<meta charset="UTF-8">
<title>Pogled 5.5.7. - pretraživanje</title>
<style type="text/css">
	body {
...
<body>
	...
	<h4>Pretraživanje udaljenost i aerodrome do polaznog aerodroma unutar odabrane države i udaljenosti</h4>
	
	<form method="GET" action="${pageContext.servletContext.contextPath}/mvc/aerodromi/udaljenost2">
	<div class="labele">

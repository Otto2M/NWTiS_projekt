 ...
 * 
 */
@WebServiceClient(name = "aerodromi", targetNamespace = "http://ws.projekt.omilermat.nwtis.foi.org/", wsdlLocation = "http://localhost:8080/omilermat_aplikacija_4/aerodromi?wsdl")
    ...
    extends Service
{
    ...
    private final static QName AERODROMI_QNAME = new QName("http://ws.projekt.omilermat.nwtis.foi.org/", "aerodromi");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/omilermat_aplikacija_4/aerodromi?wsdl");
    ...
    public WsAerodromi getWsAerodromiPort() {
        return super.getPort(new QName("http://ws.projekt.omilermat.nwtis.foi.org/", "WsAerodromiPort"), WsAerodromi.class);
    }
    ...
    public WsAerodromi getWsAerodromiPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.projekt.omilermat.nwtis.foi.org/", "WsAerodromiPort"), WsAerodromi.class, features);
    }

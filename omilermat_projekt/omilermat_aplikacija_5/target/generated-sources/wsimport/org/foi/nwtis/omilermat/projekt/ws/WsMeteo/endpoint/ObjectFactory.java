 ...
 * generated in the org.foi.nwtis.omilermat.projekt.ws.WsMeteo.endpoint package. 
...
public class ObjectFactory {
    ...
    private final static QName _DajMeteo_QNAME = new QName("http://ws.projekt.omilermat.nwtis.foi.org/", "dajMeteo");
    private final static QName _DajMeteoResponse_QNAME = new QName("http://ws.projekt.omilermat.nwtis.foi.org/", "dajMeteoResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: org.foi.nwtis.omilermat.projekt.ws.WsMeteo.endpoint
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://ws.projekt.omilermat.nwtis.foi.org/", name = "dajMeteo")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.projekt.omilermat.nwtis.foi.org/", name = "dajMeteoResponse")

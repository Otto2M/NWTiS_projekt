...
import org.foi.nwtis.omilermat.konfiguracije.KonfiguracijaBin;
import org.foi.nwtis.omilermat.konfiguracije.KonfiguracijaJson;
import org.foi.nwtis.omilermat.konfiguracije.KonfiguracijaTxt;
import org.foi.nwtis.omilermat.konfiguracije.KonfiguracijaXml;
import org.foi.nwtis.omilermat.konfiguracije.KonfiguracijaYaml;
...
public abstract class KonfiguracijaApstraktna implements Konfiguracija {
   ...
   * @see KonfiguracijaApstraktna - azuriraj postavku
   */
  @Override
   ...
   * @param kljuc - naziv postavke
   * @param vrijednost - vrijednost postavke
   * @return vraća true ako je postavka dodana ili false ako nema takve postavke
